        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    latitudes = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    longitudes = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    ...
                    DonationRate = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    DonationNumber = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfMale = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Donations_Users_applicationUserId",
